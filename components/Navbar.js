...
export default function Navbar() {
    ...
    return <div style={{color:"#FF5A5F"}} className="p-4 bg-transparent flex justify-between  absolute top-0 w-full z-50">
        <a onClick={()=>router.push('/')} style={{cursor: "pointer"}} className="font-bold text-xl font-display">
            Tech @ EP
        </a>
        <nav style={{marginBottom:"70px"}} className="flex justify-between space-x-4">
